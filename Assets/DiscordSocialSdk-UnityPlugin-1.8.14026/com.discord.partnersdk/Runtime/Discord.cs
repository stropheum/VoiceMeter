...
namespace Discord.Sdk
{
...
#endif
            PlayerLoopSystem playerLoopSystem = UnityEngine.LowLevel.PlayerLoop.GetCurrentPlayerLoop();
            List<PlayerLoopSystem> subsystems = playerLoopSystem.subSystemList.ToList();
    ...
    public static void __OnPostConstruct(Discord.Sdk.Client client) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void __InitString(Discord_String* str, string value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void __FreeString(Discord_String* str)
        {
            Marshal.FreeCoTaskMem((IntPtr)str->ptr);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool __InitStringLocal(byte* buf,
            int* bufUsed,
            int bufCapacity,
            Discord_String* str,
            string value)
        {
            ...
            int byteCountWritten = Encoding.UTF8.GetBytes(value, span);
            str->ptr = buf + *bufUsed;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool __AllocLocal(byte* buf,
            int* bufUsed,
            int bufCapacity,
            void** ptrOut,
            int size)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool __AllocLocalStringArray(byte* buf,
            int* bufUsed,
            int bufCapacity,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool __AllocateLocalBoolArray(byte* buf,
            int* bufUsed,
            int bufCapacity,
            bool** ptrOut,
            int count)
        {
            void* ptr;
            bool owned = __AllocLocal(buf, bufUsed, bufCapacity, &ptr, count * sizeof(bool));
            *ptrOut = (bool*)ptr;
            return owned;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void __FreeLocalString(Discord_String* str, bool owned)
        {
            if (owned)
            {
                Marshal.FreeCoTaskMem((IntPtr)str->ptr);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void __FreeLocal(void* ptr, bool owned)
        {
            if (owned)
            {
        ...
        public struct Client
        {
            ...
            [AOT.MonoPInvokeCallback(typeof(AuthorizeRequestCallback))]
            ...
            [AOT.MonoPInvokeCallback(typeof(IsDiscordAppInstalledCallback))]
    ...
    public class ActivityInvite : IDisposable
    {
        ...
        public void SetPartyId(string value)
        {
            ...
            unsafe
            {
                ulong* __scratchAligned = stackalloc ulong[128];
                byte* __scratch = (byte*)__scratchAligned;
                int __scratchUsed = 0;
    ...
    public class ActivityAssets : IDisposable
    {
        ...
        public void SetLargeImage(string? value)
        {
            ...
            unsafe
            {
                ...
                int __scratchUsed = 0;
                NativeMethods.Discord_String __valueSpan;
                bool __valueOwned = NativeMethods.__InitNullableStringLocal(
    ...
    public class Activity : IDisposable
    {
        ...
        public void SetStatusDisplayType(StatusDisplayTypes? value)
        {
            ...
            unsafe
            {
                StatusDisplayTypes __valueLocal = value ?? default;
                fixed (NativeMethods.Activity* self = &this.self)
                {
        ...
        public void SetApplicationId(ulong? value)
        {
            ...
            unsafe
            {
                ulong __valueLocal = value ?? default;
                fixed (NativeMethods.Activity* self = &this.self)
                {
        ...
        public void SetAssets(ActivityAssets? value)
        {
            ...
            unsafe
            {
                NativeMethods.ActivityAssets __valueLocal = value?.self ?? default;
                fixed (NativeMethods.Activity* self = &this.self)
                {
        ...
        public void SetTimestamps(ActivityTimestamps? value)
        {
            ...
            unsafe
            {
                NativeMethods.ActivityTimestamps __valueLocal = value?.self ?? default;
                fixed (NativeMethods.Activity* self = &this.self)
                {
        ...
        public void SetParty(ActivityParty? value)
        {
            ...
            unsafe
            {
                NativeMethods.ActivityParty __valueLocal = value?.self ?? default;
                fixed (NativeMethods.Activity* self = &this.self)
                {
        ...
        public void SetSecrets(ActivitySecrets? value)
        {
            ...
            unsafe
            {
                NativeMethods.ActivitySecrets __valueLocal = value?.self ?? default;
                fixed (NativeMethods.Activity* self = &this.self)
                {
    ...
    public class AuthorizationArgs : IDisposable
    {
        ...
        public void SetCodeChallenge(AuthorizationCodeChallenge? value)
        {
            ...
            unsafe
            {
                NativeMethods.AuthorizationCodeChallenge __valueLocal = value?.self ?? default;
                fixed (NativeMethods.AuthorizationArgs* self = &this.self)
                {
        ...
        public void SetIntegrationType(IntegrationType? value)
        {
            ...
            unsafe
            {
                IntegrationType __valueLocal = value ?? default;
                fixed (NativeMethods.AuthorizationArgs* self = &this.self)
                {
    ...
    public class GuildChannel : IDisposable
    {
        ...
        public void SetLinkedLobby(LinkedLobby? value)
        {
            ...
            unsafe
            {
                NativeMethods.LinkedLobby __valueLocal = value?.self ?? default;
                fixed (NativeMethods.GuildChannel* self = &this.self)
                {
    ...
    public class LobbyMemberHandle : IDisposable
    {
        ...
        public Dictionary<string, string> Metadata()
        {
            ...
            unsafe
            {
                ...
                {
                    string? key = Marshal.PtrToStringUTF8((IntPtr)__returnValueNative.keys[__i].ptr,
                        (int)__returnValueNative.keys[__i].size);
                    string? value = Marshal.PtrToStringUTF8((IntPtr)__returnValueNative.values[__i].ptr,
    ...
    public class Client : IDisposable
    {
        ...
        public Client(string apiBase, string webBase)
        {
            ...
            unsafe
            {
                ...
                bool __apiBaseOwned = NativeMethods.__InitStringLocal(
                    __scratch, &__scratchUsed, 1024, &__apiBaseSpan, apiBase);
                NativeMethods.Discord_String __webBaseSpan;
                bool __webBaseOwned = NativeMethods.__InitStringLocal(
        ...
        public Call?[] GetCalls()
        {
            ...
            unsafe
            {
                ...
                for (int __i = 0; __i < (int)__returnValue.size; __i++) __returnValueSurface[__i] = new Call(__returnValue.ptr[__i], 0);
                NativeMethods.Discord_Free(__returnValue.ptr);
                return __returnValueSurface;
            }
        }
        ...
        public void SetInputDevice(string deviceId, SetInputDeviceCallback cb)
        {
            ...
            unsafe
            {
                ...
                bool __deviceIdOwned = NativeMethods.__InitStringLocal(
            ...
            ExchangeChildTokenCallback callback)
        {
            ...
            unsafe
            {
                ...
                bool __parentApplicationTokenOwned =
            ...
            TokenExchangeCallback callback)
        {
            ...
            unsafe
            {
                ...
                bool __externalAuthTokenOwned = NativeMethods.__InitStringLocal(
            ...
            TokenExchangeCallback callback)
        {
            ...
            unsafe
            {
                ...
                bool __codeVerifierOwned = NativeMethods.__InitStringLocal(
                    __scratch, &__scratchUsed, 1024, &__codeVerifierSpan, codeVerifier);
                NativeMethods.Discord_String __redirectUriSpan;
                bool __redirectUriOwned = NativeMethods.__InitStringLocal(
        ...
        public void OpenAuthorizeDeviceScreen(ulong clientId, string userCode)
        {
            ...
            unsafe
            {
                ...
                bool __userCodeOwned = NativeMethods.__InitStringLocal(
            ...
            TokenExchangeCallback callback)
        {
            ...
            unsafe
            {
                ...
                bool __refreshTokenOwned = NativeMethods.__InitStringLocal(
            ...
            EditUserMessageCallback cb)
        {
            ...
            unsafe
            {
                ...
                bool __contentOwned = NativeMethods.__InitStringLocal(
            ...
            SendUserMessageCallback cb)
        {
            ...
            unsafe
            {
                ...
                bool __metadataKeysOwned = NativeMethods.__AllocLocalStringArray(
                    __scratch, &__scratchUsed, 1024, &__metadataKeys, metadata.Count);
                bool __metadataValuesOwned = NativeMethods.__AllocLocalStringArray(
                    __scratch, &__scratchUsed, 1024, &__metadataValues, metadata.Count);
                bool __metadataKeyOwnershipOwned = NativeMethods.__AllocateLocalBoolArray(
                    __scratch, &__scratchUsed, 1024, &__metadataKeyOwnership, metadata.Count);
                bool __metadataValueOwnershipOwned = NativeMethods.__AllocateLocalBoolArray(
                    __scratch, &__scratchUsed, 1024, &__metadataValueOwnership, metadata.Count);
                {
                    int __i = 0;
                    foreach ((string? __metadataKey, string? __metadataValue) in metadata)
                    {
            ...
            CreateOrJoinLobbyCallback callback)
        {
            ...
            unsafe
            {
                ...
                bool __secretOwned = NativeMethods.__InitStringLocal(
            ...
            CreateOrJoinLobbyCallback callback)
        {
            ...
            unsafe
            {
                ...
                bool __lobbyMetadataKeysOwned = NativeMethods.__AllocLocalStringArray(
                    __scratch, &__scratchUsed, 1024, &__lobbyMetadataKeys, lobbyMetadata.Count);
                bool __lobbyMetadataValuesOwned = NativeMethods.__AllocLocalStringArray(
                    __scratch, &__scratchUsed, 1024, &__lobbyMetadataValues, lobbyMetadata.Count);
                bool __lobbyMetadataKeyOwnershipOwned = NativeMethods.__AllocateLocalBoolArray(
                    __scratch, &__scratchUsed, 1024, &__lobbyMetadataKeyOwnership, lobbyMetadata.Count);
                bool __lobbyMetadataValueOwnershipOwned = NativeMethods.__AllocateLocalBoolArray(
                ...
                bool __memberMetadataKeysOwned = NativeMethods.__AllocLocalStringArray(
                    __scratch, &__scratchUsed, 1024, &__memberMetadataKeys, memberMetadata.Count);
                bool __memberMetadataValuesOwned = NativeMethods.__AllocLocalStringArray(
                    __scratch, &__scratchUsed, 1024, &__memberMetadataValues, memberMetadata.Count);
                bool __memberMetadataKeyOwnershipOwned = NativeMethods.__AllocateLocalBoolArray(
                    __scratch, &__scratchUsed, 1024, &__memberMetadataKeyOwnership, memberMetadata.Count);
                bool __memberMetadataValueOwnershipOwned =
                ...
                {
                    int __i = 0;
                    foreach ((string? __memberMetadataKey, string? __memberMetadataValue) in memberMetadata)
                    {
        ...
        public bool RegisterLaunchCommand(ulong applicationId, string command)
        {
            ...
            unsafe
            {
                ...
                bool __commandOwned = NativeMethods.__InitStringLocal(
        ...
        public UserHandle[] SearchFriendsByUsername(string searchStr)
        {
            ...
            unsafe
            {
                ...
                bool __searchStrOwned = NativeMethods.__InitStringLocal(
            ...
            SendFriendRequestCallback cb)
        {
            ...
            unsafe
            {
                ...
                bool __usernameOwned = NativeMethods.__InitStringLocal(
